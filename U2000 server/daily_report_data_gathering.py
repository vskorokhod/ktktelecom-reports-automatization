...
_filenames = ['1.0 VLR_Subscribers.csv',
			 ...
			 '3.0 HSS SPS MSS USN CPU Usage.csv',
			 '3.1 UMG CPU Usage.csv',
			 '3.2 UGW CPU Usage.csv',
			 'M3UA MSC Signaling Links.csv']

if __name__ == '__main__':
	for filename in _filenames:
		collect_data(filename, 'Daily report.xlsx', daily_report=True)